...
from app.routes import auth, predicted_routes, symptoms_routes, location_routes,outbreak_routes, trends_routes, disease_pie_routes, disease_history_routes, users
